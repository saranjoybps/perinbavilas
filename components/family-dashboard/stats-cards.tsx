...
const STAT_CONFIG: { key: keyof DashboardStats; icon: string; label: string; accent: string }[] = [
  { key: "totalFamilies", icon: "◉", label: "Total Families", accent: "#C09030" },
  { key: "totalChildren", icon: "◎", label: "Total Children", accent: "#5A8FAA" },
  { key: "totalImages", icon: "▣", label: "Total Images", accent: "#6BA888" },
  { key: "dataSource", icon: "◇", label: "Data Source", accent: "#7A9BB5" },
];
