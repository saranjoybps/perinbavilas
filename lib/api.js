...
export const getGalleryItems = async (status) => {
...
export const approveGalleryItem = (id) =>
...
export const submitEditRequest = (uid, data) =>
  request('/api/edit-requests', {
    method: 'POST',
    body: JSON.stringify({ uid, changes: data }),
  });
