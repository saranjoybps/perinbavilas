    ...
    <>
      ...
      {loading ? (
        ...
        <div className="flex flex-col gap-4 max-w-2xl">
          {items.map((item) => (
            <div key={item.id} className="glass-warm shadow-cloud p-4 md:p-6" style={{ borderLeft: '3px solid rgba(26, 61, 46,0.45)' }}>
              <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-3">
                <div className="min-w-0 flex-1">
                  <p style={{ fontFamily: 'var(--font-inter)', fontSize: '0.65rem', letterSpacing: '0.3em', textTransform: 'uppercase', color: 'rgba(15, 42, 31,0.6)', marginBottom: '0.5rem' }}>
