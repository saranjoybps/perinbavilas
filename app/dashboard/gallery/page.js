  ...
  return (
    <>
      <div className="mb-8">
        ...
        <p style={{ fontFamily: 'var(--font-inter)', fontSize: '0.85rem', color: 'rgba(26,16,8,0.5)', marginTop: '0.5rem', maxWidth: 480, lineHeight: 1.55 }}>
          Upload a photo for admin review. Once approved, it appears on the website Gallery page.
        </p>
              ...
              <div key={item.id} className="relative">
                ...
                <div
                  ...
                  style={{
                    ...
                    background: item.status === 'approved' ? 'rgba(47,107,66,0.9)' : 'rgba(15, 42, 31,0.85)',
                    color: '#FFF7ED',
                  }}
                >
                  {item.status}
